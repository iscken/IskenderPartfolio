        ...
        <div className={scss.content}>
          ...
          <div className={scss.message}>
            <h1 className={scss.h1}>
              Я хочу сказать вам что жизинь человека опредуляется тем что он
              считаеть истинным и правильным это и фармируют нашу рельность вот
              только что такое истина сиволишь панятия и рельность можеть
              оказатся лишь миражом а быть можеть люди живуть в собственный
              иллюзии
            </h1>
          </div>
        </div>
